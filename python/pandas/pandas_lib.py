...
#series özellikleri
print(s.index) #Index(['ali', 'ayse', 'mehmet'], dtype='str')
print(s.values) #[80 90 65]
print(s.dtype) #int64

#series ile matematiksel işlemler
veri=pd.Series([1,2,3,4,5])
sonuc=veri*2
print(sonuc)
...
print(df[["isim","yas"]])       #       isim  yas
                                # 0     ali   25
                                # 1    ayse   30
                                # 2  mehmet   28

#yeni sütun eklemle
df["maas"]=[5000,7000,9000]
print(df)
#      isim  yas     sehir  maas
# 0     ali   25    Ankara  5000
# 1    ayse   30  İstanbul  7000
# 2  mehmet   28     İzmir  9000
