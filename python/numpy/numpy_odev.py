...
dizi=np.arange(0,31)
print("10 ile 20 arasındakiler:" ,dizi[10:21])
...
print("Matris: ", matris)
print("Ortalalma: ", np.mean(matris))
print("Maksimum: ", np.max(matris))
...
rastgele=np.random.randint(1,51,10)
sonuc=np.sum(rastgele)
ortalama=np.mean(rastgele)

print("Random 10 sayı:",rastgele)
print("Toplamları:",sonuc)
