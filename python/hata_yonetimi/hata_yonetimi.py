...
yapay zekada nerelerde kullanılır?
    -veri hazırlama
    -dosya okuma
...
# int("elif") # ValueError: invalid literal for int() with base 10: 'elif'

# zero division error (sifira bölme hatası)
...
# with open("elif.txt", "r") as f:
#     print(f.read()) # FileNotFoundError: [Errno 2] No such file or directory: 'elif.txt'
...
# print("Program başarılı bir şekilde devam ediyor.")
